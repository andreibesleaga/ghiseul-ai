...
export default {
  ...
  admin: {
    ...
    logMessages: {
      ...
      userRoleUpdated: 'Peran pengguna diperbarui untuk admin@genie.gov.ro'
    },
    userName: 'Nama',
    userEmail: 'Email',
    userRole: 'Peran',
  ...
  chatbot: {
    ...
    welcomeMessage: 'Selamat datang! Bagaimana saya bisa membantu Anda dengan layanan pemerintah Romania hari ini?',
  ...
  quickhelp: {
    ...
    housingProgramsPrompt: "Beri tahu saya tentang program perumahan terjangkau di Romania",
