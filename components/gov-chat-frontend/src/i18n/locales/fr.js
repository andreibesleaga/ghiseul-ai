...
export default {
  ...
  admin: {
    ...
    logMessages: {
      ...
      userRoleUpdated: 'Rôle de l\'utilisateur mis à jour pour admin@genie.gov.ro'
    },
    userName: 'Nom',
    userEmail: 'Email',
    userRole: 'Rôle',
  ...
  quickhelp: {
    ...
    housingProgramsPrompt: "Parlez-moi des programmes de logement abordable au Romania",
