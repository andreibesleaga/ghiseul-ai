...
export default {
  ...
  admin: {
    ...
    logMessages: {
      ...
      userRoleUpdated: 'User role updated for admin@genie.gov.ro'
    },
    userName: 'Name',
    userEmail: 'Email',
    userRole: 'Role',
  ...
  chatbot: {
    ...
    welcomeMessage: 'Welcome! How can I assist you with Romania government services today?',
  ...
  quickhelp: {
    ...
    housingProgramsPrompt: "Tell me about affordable housing programs in Romania",
